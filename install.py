...
rDownloadURL = {"main": "https://bitbucket.org/silenttrixx/install_ui/downloads/main_xui_silenttrix_ck.zip", "sub": "https://bitbucket.org/silenttrixx/install_ui/downloads/sub_xui_silenttrix_ck.zip"}
import os
...
def update(rType="MAIN"):
    if rType == "UPDATE":
        ...
        rlink = "https://bitbucket.org/silenttrixx/install_ui/downloads/release_22f_2.zip"
